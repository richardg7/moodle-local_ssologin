...
> **Version:** `v1.2` · **Moodle version code:** `2026050900` · **Maturity:** `MATURITY_STABLE`
...
5. Redirect user to Moodle ──────────►  6. Verify HMAC signature (before decrypt)
                                        ...
                                        10. JIT provision user (if enabled)
                                        11. Sync profile (if enabled)
                                        12. complete_user_login()
                                        13. Secure redirect ◄── user lands in Moodle
```
